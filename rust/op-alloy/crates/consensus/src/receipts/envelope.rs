...
impl<T> OpReceiptEnvelope<T> {
    ...
    pub const fn logs_bloom(&self) -> &Bloom {
        match self {
            Self::Legacy(t) | Self::Eip2930(t) | Self::Eip1559(t) | Self::Eip7702(t) | Self::PostExec(t) => {
                &t.logs_bloom
            }
    ...
    pub fn into_receipt(self) -> Receipt<T> {
        match self {
            Self::Legacy(t) | Self::Eip2930(t) | Self::Eip1559(t) | Self::Eip7702(t) | Self::PostExec(t) => t.receipt,
...
impl OpReceiptEnvelope {
    ...
    pub fn inner_length(&self) -> usize {
        match self {
            Self::Legacy(t) | Self::Eip2930(t) | Self::Eip1559(t) | Self::Eip7702(t) | Self::PostExec(t) => t.length(),
